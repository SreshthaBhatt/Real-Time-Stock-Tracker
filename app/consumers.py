...
class StockConsumer(AsyncWebsocketConsumer):
    ...
    def addCeleryBeat(self,stockpicker):
        ...
        if len(task)>0:
            ...
            task = PeriodicTask.objects.create(interval = schedule, name='every-10-seconds', task="app.tasks.update_stock", args = json.dumps([stockpicker]))

    @sync_to_async
    def addToDB(self,stockpicker):
    ...
    async def connect(self):
        ...
        await self.addToDB(stockpicker)
